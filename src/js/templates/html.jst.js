...
this["JST"]["src/js/templates/beachBaptism.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/beach-baptism-banner.png" alt="Mercy and Justice" style="width: 100%; max-width: 500px; border: 0;">\n    <br><br>\n    <h2>Beach Baptism</h2>\n    <p>Sunday, June 26th, at 4 PM we will be at Linda Crabtree’s house in Oceanview. Bring your bathing suit, sunscreen, and a side to share! The main dish of chicken will be provided. If you are interested in being baptized please fill out the form on CCB homepage or come to the baptism interest meeting on June 12th.</p>\n    <p>Register for this event using this link: <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=91" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=91</a></p>\n</section>';

}
return __p
};

this["JST"]["src/js/templates/campContinued.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/the-camp-continued-banner-3.png" alt="The Camp Continued" style="width: 100%; max-width: 400px; border: 0;">\n    <br><br>\n    <h2>theCamp Continued</h2>\n\n    <p>Join us every Thursday afternoon, beginning July 7th, from 12:30-4pm at Ghent Elementary School (200 Shirley Avenue Norfolk, VA 23517). We will be taking 3rd-5th graders from Tidewater Park Elementary on field trips around the Hampton Roads Area. This is a great way to continue the relationships we have formed at TheCamp! Click on this link to sign up (<a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=99" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=99</a>).</p>\n</section>';

}
return __p
};

this["JST"]["src/js/templates/campus.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-blue-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/crc-campus.png" alt="CRC Campus" style="width: 100%; max-width: 300px; border: 0;">\n    <br><br>\n    <p>\n        CrossRoads Church is located a 1/2 mile away from ODU campus. We have worship services at 9 AM and 11 AM with a coffeehouse 30 minutes before each service.\n    </p>\n    <p>&nbsp;</p>\n    <h3>ODUrides</h3>\n    <p>\n        We provide a van pick-up/drop-off service for the students at ODU. A van will pick up students on campus and return them after service. The pick-up times and locations are listed below.\n    </p>\n    <p>\n        10:25 AM - The Inn<br>\n        10:30 AM - Whitehurst (right out front)<br>\n        10:33 AM - Powhatan Parking Lot<br>\n        10:35 AM - Quad (on 49th street in front of Dominion House)<br>\n        10:40 AM - Gresham and Rogers (right outside entrance to Gresham on 49th)\n    </p>\n    <p>&nbsp;</p>\n    \n    <p>For additional questions or information please contact Nicki Kristol (<a href="mailto:nicole.kristol@gmail.com">nicole.kristol@gmail.com</a>).</p>\n</section>\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/daddydaughter-banner.png" alt="Mercy and Justice" style="width: 100%; max-width: 500px; border: 0;">\n    <br><br>\n    <h2>Fairy Tale Daddy Daughter Dance</h2>\n    <p>Dads take your sweet daughters for a night out on June 17th from 6 - 8 PM. The theme is “Fairy Tale” so come dressed to impress. Dinner is provided and dancing is required.</p>\n    <p>Use the following link to view more event details: <strong><a href="/docs/dance.pdf" target="_blank">Daddy Daughter Dance Flyer</a></strong></p>\n    <p>Use the following link to register for this event: <strong><a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=95" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=95</a></strong></p>\n</section>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n\t<img src="/img/easter-banner-2016.jpg" alt="Easter Sunday" style="width:100%; max-width: 450px; border: 0; margin-bottom: 25px;">\n\t<section>\n\t    <h2>Prayer Night</h2>\n\t    <p><strong>Tuesday, March 22nd from 7pm - 8pm</strong> at CrossRoads Church. We will gather together to pray for people by name and for the service in general.</p>\n\t</section>\n\t<p>&nbsp;</p>\n\t<section class="alternate">\n\t    <h2>Good Friday Service</h2>\n\t    <p><strong>Friday, March 25th from 6:30pm - 8pm</strong> at CrossRoads Church.</p>\n\t</section>\n\t<p>&nbsp;</p>\n\t<section>\n\t    <h2>Easter Eggstravaganza</h2>\n\t    <p><strong>Saturday, March 26th from 10:30am - 12:30pm</strong> at Bluestone Park.</p>\n\t    <p>Come and enjoy an egg hunt, bounce house, games, egg dying, and fun with friends! Bring a picnic lunch for the whole family, blankets and/or lawn chairs. </p>\n\t</section>\n\t<p>&nbsp;</p>\n\t<section class="alternate">\n\t    <h2>Easter Services</h2>\n\t    <p><strong>Sunday, March 27th at 9am and 11am</strong> at CrossRoads Church.</p>\n\t    <p>Refuel Coffeehouse opens at 8:30am.  <strong>Visitor and special needs parking is available directly in front of the church on Surrey Crescent</strong>.\n\t</section>\n</section>\n';

}
return __p
};

this["JST"]["src/js/templates/entrusted.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/entrusted-page-banner.png" style="width: 100%; max-width: 400px; border: 0;">\n    <br><br>\n    <h2>November 18 - 19, 2016</h2>\n    <h3>Register Now!</h3>\n    <p>\n        Use this link to register for the conference: <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=119" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=119</a>.\n    </p>\n    <p>&nbsp;</p>\n    <h3>Location</h3>\n    <p>\n        Hosted by CrossRoads Church:<br>\n        <a href="http://maps.google.com/?q=1127%Surrey%Crescent%Norfolk%VA%23508" target="_blank">1127 Surrey Crescent, Norfolk VA</a>\n    </p>\n</section>\n<section class="alternate">\n    <h3>Is the Entrusted Conference for Me?</h3>\n    <ul>\n        <li>I\'m curious about fostering or adopting</li>\n        <li>I\'m actively pursuing fostering or adoption</li>\n        <li>I\'ve been matched with a waiting child</li>\n        <li>I\'m a foster parent and/or have already adopted</li>\n        <li>My friend/family has adopted and I want to better understand their journey</li>\n    </ul>\n</section>\n<section>\n    <h3>Cost</h3>\n    <p>\n        $30/individual<br>\n        $50/couple\n    </p>\n    <p>&nbsp;</p>\n    <h3>Main Session Topics:</h3>\n    <ul>\n        <li>THE BIBLE AND ADOPTION: why me?</li>\n        <li>A FAMILY UNITED: when adoption is our mission</li>\n        <li>CONFLICTED IDENTITY: your past doesn\'t define you, but it\'s a part of who you are</li>\n    </ul>\n    <p>&nbsp;</p>\n    <h3>Breakout Sessions:</h3>\n    <ul>\n        <li>Domestic Infant Adoption</li>\n        <li>Foster Care/Adoption from Foster Care</li>\n        <li>International Adoption</li>\n        <li>Where Do I Start?</li>\n        <li>Financing/Fundraising Ideas</li>\n        <li>Navigating Open Adoption/Birth Families</li>\n        <li>Special Needs Adoption</li>\n        <li>When My Spouse Feels Called, but I\'m Not There Yet</li>\n        <li>Bringing Church Awareness</li>\n        <li>Transracial Adoption</li>\n        <li>Parenting After Adoption</li>\n        <li>When Love Isn\'t Instant</li>\n        <li>Strategies to Cope with Attachment Disorders</li>\n\n    </ul>\n    <p>&nbsp;</p>\n    <h3>Schedule</h3>\n    <p><strong>Friday (November 18th)</strong></p>\n    <table>\n        <tr>\n            <td>7 PM</td>\n            <td>Worship and Welcome</td>\n        </tr>\n        <tr>\n            <td>7:30 PM &nbsp;</td>\n            <td>Main Session #1</td>\n        </tr>\n        <tr>\n            <td>8:45 PM</td>\n            <td>Breakout Session #1</td>\n        </tr>\n        <tr>\n            <td>9:30 PM</td>\n            <td>Dismiss</td>\n        </tr>\n    </table>\n    <p><strong>Saturday (November 19th)</strong></p>\n    <table>\n        <tr>\n            <td>9 AM</td>\n            <td>Worship and Welcome</td>\n        </tr>\n        <tr>\n            <td>9:30 AM</td>\n            <td>Breakout Session #2</td>\n        </tr>\n        <tr>\n            <td>10:15 AM &nbsp;</td>\n            <td>Agency Exhibit/shopping</td>\n        </tr>\n        <tr>\n            <td>11 AM</td>\n            <td>Main Session #2</td>\n        </tr>\n        <tr>\n            <td>12 PM</td>\n            <td>Q&amp;A Panel/Lunch</td>\n        </tr>\n        <tr>\n            <td>1:30 PM</td>\n            <td>Breakout Session #3</td>\n        </tr>\n        <tr>\n            <td>2:15 PM</td>\n            <td>Main Session #3</td>\n        </tr>\n        <tr>\n            <td>3:15 PM</td>\n            <td>Dismiss</td>\n        </tr>\n    </table>\n</section>\n<section class="alternate">\n    <h3>Kids Movie Night</h3>\n    <p>\n        There is a movie night option being offered at the church for ages 5+ on Friday night for an additional fee - $5/child or $15/family\n    </p>\n    <p style="font-style: italic;">* You must register for this event when you register for the conference.*</p>\n</section>\n<section>\n    <h3>MAIN SESSION SPEAKERS</h3>\n    <h4>Nick and Kristle Davis</h4>\n    <img src="/img/DavisPhoto.png" style="width: 100%; max-width: 400px; border: 0;">\n    <p>\n        Kristle grew up to drug, alcohol and mentally affected parents. As the abuse in her family escalated, she sought help through the foster care system as a young teenager. Seven foster homes later, her forever family stepped in and dramatically changed her future.\n    </p>\n    <p>\n        Nick, having had an “all American” childhood, met Kristle during their college years and they married in 2004. Nick and Kristle suffered 2 miscarriages before they were blessed with 2 biological children.\n    </p>\n    <p>\n        After 10 years of engaging in a limited way, the Davises accepted their calling to foster care and adoption. They adopted a son in 2016 and use this story of coming full circle to establish church engagement in community outreach.\n    </p>\n    <p>\n        Click <a href="https://vimeo.com/106782841" target="_blank"><strong>HERE</strong></a> to watch a video of Kristle sharing more of her journey through foster care.\n    </p>\n    <p>\n        Use this link to register for the conference: <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=119" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=119</a>.\n    </p>\n</section>\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/Financial-Peace-University.jpg" alt="Dave Ramsey Financial Peace" style="width: 100%; max-width: 400px; border: 0;">\n    <br><br>\n    <h2>Financial Peace Class</h2>\n    <p>\n        This life-changing class taught by Dave Ramsey and the FPU teaching team on video will be coordinated by Jason Witt. It help you achieve your financial goals by showing you how to eliminate debt, save for the future, and give like never before!\n    </p>\n    <p>\n        The class will be held during 2nd service for 9 weeks starting on September 25th. Please register in advance by September 18th. The cost is $75 per person. Scholarships are available upon request. Childcare is provided.\n    </p>\n    <p>\n        Use this link to register: <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=115" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=115</a>.\n    </p>\n</section>';
...
this["JST"]["src/js/templates/live.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-orange-small.png" alt="CrossRoads Church Norfolk"></a>\n<section id="live">\n    \n</section>';
...
this["JST"]["src/js/templates/mercyAndJustice.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/mercy-justice-banner.png" alt="Mercy and Justice" style="width: 100%; max-width: 500px; border: 0;">\n    <br><br>\n    <h2>Mercy &amp; Justice Forum: A Call to Prayer </h2>\n    <p>Join us on  June 9th from 7 - 8:30 PM for a time of discussion and prayer about God’s heart for mercy and justice and how CrossRoads can be a part of that in the Hampton Roads area. Contact Hannah Rader (<a href="mailto:hannah@crossroadsnorfolk.com">hannah@crossroadsnorfolk.com</a>) for more info.</p>\n</section>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/picnic-banner.png" alt="Spring Picnic" style="width: 100%; max-width: 540px; border: 0;">\n    <br><br>\n    <h2>Spring Picnic</h2>\n    <p>Come out for our Spring picnic on Sunday April 24th at Bluestone Park (behind the ODU Football stadium). The picnic will begin at 5 PM and we will eat at 5:30 PM. Bring a side or desert to share with everyone. The main dish of baked and fried chicken is provided. </p>\n</section>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <h2>Starting Point</h2>\n    <p>\n        Starting Point is a class for people newer to CrossRoads Church to come and learn about us, discover how you can get plugged in, and ask any questions you have about the church. The next one is November 6th from 4 - 5 PM in the cafe. Child care can be provided upon request.\n    </p>\n    <p>\n        Please use our <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=121" target="_blank">online form</a> to register.  For more information, please contact Clark Taylor at <a href="mailto:clark@crossroadsnorfolk.com">clark@crossroadsnorfolk.com</a>.\n    </p>\n    <p><a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=121" target="_blank">Click here to sign up for Starting Point!</a></p>\n</section>\n';

}
return __p
};

this["JST"]["src/js/templates/summerSchedule.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-blue-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/summer-schedule-details.png" alt="Summer Schedule Details" style="width: 100%; max-width: 500px; border: 0;">\n</section>';

}
return __p
};

this["JST"]["src/js/templates/swag.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/swag-banner.png" alt="College SWAG" style="width: 100%; max-width: 500px; border: 0;">\n    <br><br>\n    <h2>College SWAG</h2>\n    <p>SWAG is for college age students. It is a summer bible study and hang out. Below are the dates and events for the summer. </p>\n    <table>\n        <tr>\n            <td>May 24th &nbsp;</td><td>Kick-Off Cook Out sat 7 PM</td>\n        </tr>\n        <tr>\n            <td>May 31st &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>June 7th &nbsp;</td><td>Jungle golf (Putt Putt)- Meet at CrossRoads at 7 PM then drive to VA beach - 302 23rd St, Virginia Beach, VA 23451</td>\n        </tr>\n        <tr>\n            <td>June 14th &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>June 21st &nbsp;</td><td>Tides game Game starts at 7 PM- Meet at CrossRoads at 6 PM. The cost is $12 per person. </td>\n        </tr>\n        <tr>\n            <td>June 28th &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>July 5th &nbsp;</td><td>To be announced.</td>\n        </tr>\n        <tr>\n            <td>July 12th &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>July 19th &nbsp;</td><td>Cornhole tournament at 7 PM at CrossRoads</td>\n        </tr>\n        <tr>\n            <td>July 26th &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>August 2nd &nbsp;</td><td>To be announced.</td>\n        </tr>\n        <tr>\n            <td>August 9th &nbsp;</td><td>Bible Study at CrossRoads at 7 PM</td>\n        </tr>\n        <tr>\n            <td>August 16th &nbsp;</td><td>End of Summer Party at 7 PM</td>\n        </tr>\n    </table>\n</section>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n    <img src="/img/camp-banner-small.png" alt="The Camp" style="width: 100%; max-width: 600px; border: 0;">\n    <br><br>\n    <h2>theCamp2016: June 27th - July 1st</h2>\n\n    <p>Visit theCamp website to register: <a href="http://www.thecamp757.com" target="_blank">www.thecamp757.com</a></p>\n \n    <p>TheCamp is a high quality sports, arts, and bible camp for a week at the beginning of each summer that takes place in the inner city of Norfolk.  It has become a major event in the life of CrossRoads Church - volunteers serving, loving and caring for campers.  This is a primary mercy and justice mission for the church and acts as “VBS” for our CrossRoads kids.  It has spawned summer-long activities that have proven to reduce the loss of learning that traditionally happens over the summer.</p>\n     \n    <p>By ourselves, CrossRoads Church doesn\'t have the resources to serve this expanding ministry.  We have partnered with Trinity Presbyterian, OV Church and several other local organizations to make theCamp a reality every summer.</p>\n     \n    <p>All volunteers are required to attend a 2 hour training prior to the week of theCamp.  Dates for this year are as follows:</p>\n    \n    <ul> \n        <li>June 19th 4 - 6PM at Trinity Presbyterian</li>\n        <li>June 21st 6 - 8PM at P.B. Young Elementary School</li>\n        <li>June 23rd 6 - 8PM at CrossRoads Church</li>\n    </ul>\n     \n    <p>For more information, please contact Clark Taylor – <a href="mailto:clark@crossroadsnorfolk.com">clark@crossroadsnorfolk.com</a></p>\n</section>';
...
this["JST"]["src/js/templates/volunteerAppreciation.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
