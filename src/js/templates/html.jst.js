...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a href="/" id="logo-mobile"><img src="/img/logo-green-small.png" alt="CrossRoads Church Norfolk"></a>\n<section>\n\t<img src="/img/crc-women.PNG" alt="CrossRoads Women" style="border: 0; width: 100%; max-width: 400px;">\n\t<p>&nbsp;</p>\n\t<h3>Women\'s Summer Events:</h3>\n\t<p>\n\t\n\t</p>\n\t<p>&nbsp;</p>\n\t<h3>Cupcakes & Coloring</h3>\n\t<p>\n\t\tJune 15th at 7pm at CrossRoads\n\t\tCome out to eat treats and color from adult coloring books\n\t\tAll supplies and food are provided\n\t</p>\n\t\n\t</p>\n\t<p>&nbsp;</p>-->\n\t<h3>Clothing Swap</h3>\n\t<p>\n\t\tJuly 20th at 7pm at CrossRoads\n\t\tBring any and all women’s clothing, shoes and accessories to swap and shop.\n\t</p>\n\t<p>&nbsp;</p>\n\t<h3>Craft Night</h3>\n\t<p>\n\t\tAugust 17th, 6pm, The Mermaid Factory\n\t\tThe cost for this event is $25. Click on this link to register: <a href="https://crcnorfolk.ccbchurch.com/form_response.php?id=100" target="_blank">https://crcnorfolk.ccbchurch.com/form_response.php?id=100</a></p>\n\t</p>\n\t<p>&nbsp;</p>\n\t<h3>Women\'s Monday Bible Study</h3>\n\t<p>\n\t\tMondays from 6:30-8pm\n\t\tHebrews by Jen Wilkin\n\t\tContact Ali Hill (alleighch@yahoo.com) or Kristen Boden (kristin. boden@gmail.com) for more information.\n\t</p>\n\t<p>&nbsp;</p>\n\t<h3>Military Spouse Bible Study</h3>\n\t<p>\n\t\tJuly 6th- August 10th, Wednesdays from 7:30-9pm\n\t\tTour of Duty: Preparing our Hearts for Deployment by Sara Horn \n\t\tThis study is geared towards military spouses, but all women are welcome.\n\t\tContact Jen Beattie (jenandjonbeattie@yahoo.com) or Tori McCrillis (mccrillis5@gmail.com) for location details. \n\t</p>\n\t<p>&nbsp;</p>\n\t<h3>Beach Days/Play Dates</h3>\n\t<p>\t\n\t\tThere will be weekly beach days (for any/all women and families) and playground dates (for moms with kids) throughout the summer. To get up to date information on either of these activities, please email Ashley Lane (ashley@crossroadsnorfolk.com) to be added to the GroupMe\nconversations.\n\n</section>\n';
